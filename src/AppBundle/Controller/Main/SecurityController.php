...
{
    /**
     * @Route("/login", name="app_main_security_login")
     *
    ...
    {
        return $this->render('AppBundle:Main/Security:login.html.twig', $data);
    }

    /**
     * @Route("/check", name="app_main_security_check")
     */
    ...
    /**
     * @Route("/logout", name="app_main_security_logout")
     */
